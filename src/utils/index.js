...
export function get3PointAroundCenter(data) {
  ...
  let threePoint = [],
    remainOrgs = []
  const orgNames = [
    'Nhà chăm sóc người cao tuổi cộng đồng Caoyang Thượng Hải',
    'Nhà chăm sóc người già ở phố Shiquan, quận Phổ Đà, Thượng Hải',
    'Nhà cho người cao tuổi ở Taoyuan, Putuo District, Thượng Hải',
  ]
  d.forEach((c, index) => {
...
//Tính điểm gần điểm nhất trong tập hợp các điểm
