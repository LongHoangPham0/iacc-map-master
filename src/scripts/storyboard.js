...
export default class Storyboard {
  ...
  async startGodStory(markerAudio) {
    ...
    //Tạo điểm đánh dấu trụ sở chính
    ...
    //Cảnh mở đầu tạo ba tổ chức bên cạnh chúng, vòng tròn và tia bắn vào chúng tương ứng
  ...
  returnToGodStory() {
    document.body.insertAdjacentHTML(
      'beforeend',
      tipsTemp({
        tips: 'Nhấp vào tên của tổ chức để vào chế độ cộng đồng'
      })
    )
    this.mapinstance.setCenter(new AMap.LngLat(AiZhaohu.lng, AiZhaohu.lat))
